function [tsd,sig]=rs1df(wave,nr,N,rL,h,kl,ku,Nf,sdim,g,tid,nsa,seed)
%rs1df computes the bistatic scattering coefficient for bandlimited fractal
%   rough surfaces 
%
%   [tsd,sig]=rs1df(wave,nr,N,rL,h,kl,ku,Nf,sdim,g,tid,nsa,seed)
%
%   INPUT:
%
%   wave=wavelength
...
%
%	 REQUIRES: rsgenf.m for generation of fractal rough surfaces
%

function valM = spsH(colId,rowId,fpa_x,fpa_y,src_x,src_y)
% 15 September 04
...
% read in basisH file
fid = fopen('matdata.dat'); % for the maximum basis set with the modeled code
[a] = fscanf(fid,'%e',[41 254]); % It has two rows now.
fclose(fid);

function ntG = sps_CGH_sim(src_fname,out_fname,detector_D,separation_d,FPA_sizeX,FPA_sizeY,rad_1,rad_2,rad_3,pxl_cnt, dim_mm_xy);
% give detector_D in millimeters (must be the same as the dimenions on the
...
for bp = 1:2
    ...
    % points
    % each iteration (3) for each point should have degraded intensity
for ir = 1:2
    rt = 1+ir;
    im_end = m_orders^ir;
